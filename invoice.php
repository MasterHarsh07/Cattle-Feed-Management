...
<h6 class="mb-5">Cattle Feed Management System</h6>
</div>
...
$cnt++;
  ...
  <tr>
<th colspan="6" style="text-align:center; font-size:20px;">Portal</th> 
<th style="text-align:left; font-size:20px;"><?php echo number_format(40);?></th>   
